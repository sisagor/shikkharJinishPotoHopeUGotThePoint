...
Route::prefix('cms')->name('cms.')->middleware(['auth'])->group(function () {
    ...
    Route::controller(Modules\CMS\Http\Controllers\JobController::class)->group(function (){
        //jobPosting
    ...
    Route::controller(Modules\CMS\Http\Controllers\JobApplicationController::class)->group(function (){
        //jobApplications
    ...
    Route::controller(Modules\CMS\Http\Controllers\InterviewController::class)->group(function (){
        //Interviews
    ...
    Route::controller(Modules\CMS\Http\Controllers\OfferController::class)->group(function (){
        //Blog Offer
