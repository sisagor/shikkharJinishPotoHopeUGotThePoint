                        ...
                        <li class="checkbox-todo-custom mt-2">
                            <div class="col-md-12 col-12 custom-checkbox2">
                                <input type="checkbox" value="1" class="flat"
                                       ...
                                       @if(config('system_settings.has_provident_fund')) checked @endif /> &nbsp;
                            ...
                            <div class="col-md-12 col-sm-12 mt-2">
                                ...
                                <div class="item form-group">
                                    <input class="form-control" type="text" maxlength="3" id="employee_pf"
                                           value="{{config('system_settings.employee_pf') ?? 0}}"
                                           name="employee_pf" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="item form-group">
                                    <input class="form-control" type="text" maxlength="2" id="company_pf"
                                           value="{{config('system_settings.company_pf') ?? 0}}"
                                           name="company_pf"/>
                                </div>
                            </div>
                        </li>
        ...
        <fieldset>
            ...
            <ul class="to_do">
                <li class="checkbox-todo-custom mt-2">
                    <div class="col-md-12 col-12 custom-checkbox2">
                        <input type="checkbox" value="1" class="flat"
                               name="has_welfare_fund" @if(config('system_settings.has_welfare_fund')) checked @endif /> &nbsp;
                    ...
                    <div class="col-md-12 col-sm-12 mt-2">
                        ...
                        <div class="item form-group">
                            <input class="form-control" type="text" id="default_password" value="{{config('system_settings.welfare_fund_amount') ?? 0}}" name="welfare_fund_amount" />
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <fieldset class="mt-2">
            ...
            <ul class="to_do">
                <li class="checkbox-todo-custom mt-2">
                    <div class="col-md-12 col-12 custom-checkbox2">
                        <input type="checkbox" value="1" class="flat"
                               name="has_gratuity" @if(config('system_settings.has_gratuity')) checked @endif /> &nbsp;
                    ...
                    <div class="col-md-12 col-sm-12 mt-2">
                        ...
                        <div class="item form-group">
                            <input class="form-control" maxlength="2" type="text" id="gratuity_apply_after" value="{{config('system_settings.gratuity_apply_after') ?? 0}}"
