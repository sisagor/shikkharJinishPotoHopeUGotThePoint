    ...
    <div class="form-body">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="item form-group">
                    <select class="form-control" data-link="{{route('recruitment.application.ajax')}}"
                            data-child-id="job_application_id" id="parent_id" name="job_id" disabled>
                        <option value="">{{trans('app.select')}}</option>
                        @if(! empty($interview->application->job))
                            <option value=""selected>{{ $interview->application->job->position }}</option>
                        @endif
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="item form-group">
                    <select class="form-control" id="job_application_id" name="job_application_id" disabled >
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="item form-group">
                    <input id="interview_date" class="form-control datePicker" type="text" name="interview_date" readonly
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="item form-group">
                    <input id="interview_time" class="form-control timePicker" type="text" name="interview_time" readonly
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="item form-group">
                    <input id="interview_place" class="form-control" type="text" name="address" readonly
