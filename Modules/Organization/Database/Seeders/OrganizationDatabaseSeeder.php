...
class OrganizationDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $module = include(module_path('organization', 'Config/module.php'));
        ...
        try {
            ...
            ##demo
            if (config('app.demo')) {
                $this->call(DemoOrganizationDatabaseSeeder::class);
                $this->call(DemoDeductionPolicyDatabaseSeeder::class);
                $this->call(DemoLeavePolicyDatabaseSeeder::class);
            }
            ...
            DB::rollBack();
            Log::error("Organization create Error!");
