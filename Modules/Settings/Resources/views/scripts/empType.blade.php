    ...
    ;(function ($, window, document) {
        ...
        $(document).ready(function () {
            ...
            let active = $('.active-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('componentSettings.employmentTypes').'?type=active'!!}',
                    type: 'GET',
                    data: function (d) {
                        filterData(d);
                    }
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name'},
                    {data: 'allow_company_facility', name: 'allow_company_facility'},
            ...
            let trash = $('.trash-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('componentSettings.employmentTypes').'?type=trash'!!}',
                    type: 'GET',
                    data: function (d) {
                        filterData(d);
                    }
