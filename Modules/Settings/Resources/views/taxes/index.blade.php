@extends('layouts.tableTab', ['title' => 'taxes', 'btnType' => 'modal'])
...
{{--Add button--}}
@section('buttons')
    {!! add_button('componentSettings.tax.add', 'new_tax') !!}
@endsection
...
@section('active')
    <table class="active-table table table-striped table-bordered no-footer dtr-inline w-100" role="grid" aria-describedby="datatable-buttons_info">
        ...
        <tr>
            <th>#</th>
            <th>{{trans('app.eligible_amount')}}</th>
            <th>{{trans('app.tax')}}</th>
