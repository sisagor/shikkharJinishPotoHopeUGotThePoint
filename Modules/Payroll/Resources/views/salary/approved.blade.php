@extends('layouts.report', ['title' => 'approved_salaries', 'filter' => 1])


@section('filter')
   {{-- {!! employee_search_filed(2) !!}--}}
    {!! month_search_filed(3) !!}
@endsection

@section('report')
    <table class="approved-salary-table table table-striped table-bordered no-footer dtr-inline w-100" role="grid" aria-describedby="datatable-buttons_info">
        <thead>
        <tr>
            <th>#</th>
