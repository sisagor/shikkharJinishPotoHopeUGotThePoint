        ...
        <div class="row">
                ...
                <fieldset>
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="item form-group">
                            <select class="full-width form-control"type="text" id="designation_id" name="designation_id" disabled>
                                @foreach(get_designations() as $id => $name)
                                    <option value="{{ $id }}"
                                            @if(! empty($rule)) @if($rule->designation_id == $id) selected @endif @endif>{{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-4">
                <fieldset>
                    ...
                    @foreach($structures->filter(function ($item){ return $item->salaryStructure->type == \Modules\Payroll\Entities\SalaryStructure::TYPE_ADD;}) as $add)
                        <div class="col-md-12 col-sm-12">
                            <label class="col-form-label label-align" for="{{ $add->salaryStructure->name }}">
