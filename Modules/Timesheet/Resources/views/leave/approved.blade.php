@extends('layouts.table', ['title' => 'approved_applications', 'btnType' => 'modal', 'filter' => 1])
...
@section('table')
    ...
    <table class="leave-application-approve table table-striped table-bordered no-footer dtr-inline w-100" role="grid" aria-describedby="datatable-buttons_info">
        <thead>
        <tr>
            <th>#</th>
