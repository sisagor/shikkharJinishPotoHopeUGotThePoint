                            ...
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    ...
                                    <img class="img-responsive avatar-view"
                                         src="{{ get_storage_file_url(optional($branch->profile)->path, 'profile') }}"
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="item form-group">
                                            <input class="form-control" type="text" id="name" name="name" required
                                                   value="@if(!empty($branch)){{$branch->name}}@endif"
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="item form-group">
                                            <input class="form-control" id="phone" type="text" name="phone" required
                                                   value="@if(!empty($branch)){{$branch->phone}}@endif"
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="item form-group">
                                            <input id="email" class="form-control" type="email" name="email" required
                                                   value="@if(!empty($branch)){{$branch->email}}@endif"
                                                   placeholder="{{trans('app.email')}}">
                                        </div>
                                    </div>

                                   {{-- <div class="col-md-6 col-sm-6">
                                        <label class="col-form-label label-align" for="commission_percent">
                                            {{trans('app.commission_percent')}}
                                        </label>
                                        <div class="item form-group">
                                            <input id="commission_percent" class="form-control" type="text"
                                                   name="commission_percent"
                                                   value="@if(!empty($branch)){{$branch->commission_percent}}@endif"
                                                   placeholder="{{trans('app.commission_percent')}}">
                                        </div>
                                    </div>--}}
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="item form-group">
                                            <input id="address" class="form-control" type="text" name="address"
                                                   value="@if(!empty($branch)){{$branch->address}}@endif"
