    ...
    public function updatePersonalInfo(Request $request, $id): bool
    {
        try {
            ...
            $employee->update([
                ...
                'prl_date' => $request->get('prl_date'),
                'posted_as' => $request->get('posted_as'),
                'joining_back_verified' => $request->get('joining_back_verified'),
                'hris_id' => $request->get('hris_id'),
                'bcs_batch_no' => $request->get('bcs_batch_no'),
                'status' => $request->get('status'),
                'code_no' => $request->get('code_no'),
                'study_deputation_number' => $request->get('study_deputation_number'),
                'original_designation' => $request->get('original_designation'),
                'nid' => $request->get('nid'),
                'acr_availability' => $request->get('acr_availability'),
                'educational_qualification' => $request->get('educational_qualification'),
                'actual_degree' => $request->get('actual_degree'),
                'educational_discipline' => $request->get('educational_discipline'),

                // ? Other Information
                'tribe' => $request->get('tribe'),
                'freedom_fighter' => $request->get('freedom_fighter'),
                'lives_in_govt_quarter' => $request->get('lives_in_govt_quarter'),
                'professional_discipline' => $request->get('professional_discipline'),
                'staff_professional_category' => $request->get('staff_professional_category'),
                'job_status' => $request->get('job_status'),
                'health_service_joining_date' => $request->get('health_service_joining_date'),
                'current_place_joining_date' => $request->get('current_place_joining_date'),
                'current_designation_joining_date' => $request->get('current_designation_joining_date'),
                'current_pay_scale_hold' => $request->get('current_pay_scale_hold'),
                'current_basic_pay' => $request->get('current_basic_pay'),

                // ? Additional Information
                'last_promotion_information' => $request->get('last_promotion_information'),
                'training_information' => $request->get('training_information'),
                'first_appointment_information' => $request->get('first_appointment_information'),
                'bcs_psc_information' => $request->get('bcs_psc_information'),
                'service_confirmation_information' => $request->get('service_confirmation_information'),
                'senior_scale_pass' => $request->get('senior_scale_pass'),
                'experience_in_village' => $request->get('experience_in_village'),
