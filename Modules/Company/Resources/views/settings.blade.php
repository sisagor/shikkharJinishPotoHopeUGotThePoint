...
<div class="x_panel">
<div class="x_title">
    <h2> {{ trans('app.company_settings')}}</h2>
                            ...
                            <ul class="to_do">
                                <li class="checkbox-todo-custom mt-2">
                                    <div class="col-md-12 col-12" style="position: relative; margin-top: -4px;">
                                        ...
                                        <strong
                                            style="font-size: large"> {{trans('app.enable_device')}} </strong>
                        ...
                        <ul class="to_do">
                            ...
                            <li class="checkbox-todo-custom mt-2">
                                <div class="col-md-12 col-12" style="position: relative; margin-top: -4px;">
                                    ...
                                    <strong
                                        style="font-size: large"> {{trans('app.has_attendance_deduction_policy')}} </strong>
                                    <i class="fa fa-question-circle" data-toggle="tooltip"
                                       data-placement="top"
                            ...
                            <li class="checkbox-todo-custom mt-2">
                                <div class="col-md-12 col-12" style="position: relative; margin-top: -4px;">
                                    ...
                                    <strong
                                        style="font-size: large"> {{trans('app.has_allowances')}} </strong>
                                    <i class="fa fa-question-circle" data-toggle="tooltip"
                                       data-placement="top"
                          ...
                          {{--  <li class="checkbox-todo-custom mt-2">
                                <div class="col-md-12 col-12" style="position: relative; margin-top: -4px;">
                                    ...
                                    <strong
                                        style="font-size: large"> {{trans('app.allow_holiday_work_as_overtime')}} </strong>
                                    <i class="fa fa-question-circle" data-toggle="tooltip"
                                       data-placement="top"
                            ...
                            <li class="checkbox-todo-custom mt-2">
                                <div class="col-md-12 col-12" style="position: relative; margin-top: -4px;">
                                    ...
                                    <strong
                                        style="font-size: large"> {{trans('app.allow_bulk_upload')}} </strong>
                                    <i class="fa fa-question-circle" data-toggle="tooltip"
                                       data-placement="top"
                                       title="{{ trans('help.allow_bulk_upload')}}"></i>
                                </div>
                            </li>
                        ...
                        <ul class="to_do">
                            ...
                            <li class="checkbox-todo-custom mt-3">
                                <div class="col-md-12 col-12" style="position: relative; margin-top: -4px;">
                                    ...
                                    <strong
                                        style="font-size: large"> {{trans('app.has_provision_period')}} </strong>
                                    <i class="fa fa-question-circle" data-toggle="tooltip"
                                       data-placement="top"
